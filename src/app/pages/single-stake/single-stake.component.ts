...
@Component({
  selector: 'app-single-stake',
  templateUrl: './single-stake.component.html',
  styleUrls: ['./single-stake.component.css']
})

export class SingleStakeComponent implements OnInit {
  ...
  constructor(
    ...
    this.singleStakeContractService.lpBalance.subscribe(
      (amount: any) => {
    ...
    this.singleStakeContractService.stakingBalance.subscribe(
      (amount: any) => {
    ...
    this.singleStakeContractService.totalStakingBalance.subscribe(
      (amount: any) => {
    ...
    this.singleStakeContractService.rewardsBalance.subscribe(
      (amount: any) => {
        if (amount) {
    ...
    this.singleStakeContractService.rewardsPerStakeToken.subscribe(
      (amount: any) => {
        if (amount) {
    ...
    this.singleStakeContractService.stakingEndTime.subscribe(
      (time: any) => {
        // if (time) {
    ...
    this.singleStakeContractService.stakingReceipt.subscribe(
      (result: any) => {
    ...
    this.singleStakeContractService.totalLiquidity.subscribe(
      (result: any) => {
        if (result) {
  ...
  async ngOnInit() {
    ...
    if (!this.metaMaskConnected || !this.isMetaMaskAccountConnected || this.connectToNetwork) {
      ...
      this.singleStakeContractService.getStakingBalance();
      this.singleStakeContractService.getTotalStakingBalance();
      this.singleStakeContractService.getRewardsBalance();
      this.singleStakeContractService.getRewardsPerStakeToken();
      this.singleStakeContractService.getDuration();
      this.singleStakeContractService.getStakingEndTime();
      this.singleStakeContractService.getLpBalance();
  ...
  stakeAmount() {
    if (!this.metaMaskConnected || !this.isMetaMaskAccountConnected || this.connectToNetwork) {
      ...
      this.singleStakeContractService.stakeAmount(this.amountToBeStakedOrUnstaked);
    }
  }
  ...
  unstakeAmount() {
    if (!this.metaMaskConnected || !this.isMetaMaskAccountConnected || this.connectToNetwork) {
      ...
      this.stakingStarted = true;
      this.singleStakeContractService.unstakeAmount(this.amountToBeStakedOrUnstaked);
    }
  }
  ...
  claimReward() {
    if (!this.metaMaskConnected || !this.isMetaMaskAccountConnected || this.connectToNetwork) {
      ...
      this.singleStakeContractService.claimReward()
